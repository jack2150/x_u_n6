...
// ALTER TABLE `captcha` ADD `ip` VARCHAR( 15 ) NULL DEFAULT NULL AFTER `ckey` ;
@mysql_query("insert into captcha values (null , '".time()."', '$private_key', '$captchaKey', '$_SERVER[REMOTE_ADDR]')");
// close db
mysql_close($db);
