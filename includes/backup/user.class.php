    ...
    */
    ...
    global $db,$input,$uploadURL;
        ...
        $this->cgi_upload_url   = $uploadURL."/cgi-bin/upload.cgi";
       	...
       	*/
        $this->cgi_upload_url   = "http://upload2.xun6.com/cgi-bin/upload.cgi";
        $this->php_upload_url   = "http://upload2.xun6.com/uploading.php";
        $this->php_progress_url = "http://upload2.xun6.com/progress.php";
       	
		// testing jan 12 2011
		/*
        if ($this->server_id == 1 || $this->server_id == 2 || 
        	$this->server_id == 100 || $this->server_id == 101 ||
        	$this->server_id == 102 || $this->server_id == 103 ||
        	$this->server_id == 104 || $this->server_id == 105 ||
        	$this->server_id == 106 || $this->server_id == 107 ||
        	$this->server_id == 108 || $this->server_id == 109 ||
        	$this->server_id == 110 || $this->server_id == 111 ||
        	$this->server_id == 112 || $this->server_id == 113 ||
        	$this->server_id == 200 || $this->server_id == 201 ||
        	$this->server_id == 202 || $this->server_id == 203) {
